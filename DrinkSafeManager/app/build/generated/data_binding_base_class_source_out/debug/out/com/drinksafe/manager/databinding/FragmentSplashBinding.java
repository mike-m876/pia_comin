...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivLogo,
      @NonNull LinearProgressIndicator progressBar, @NonNull TextView tvNombreApp,
      @NonNull TextView tvSubtitulo) {
    this.rootView = rootView;
    this.ivLogo = ivLogo;
    this.progressBar = progressBar;
    this.tvNombreApp = tvNombreApp;
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_nombre_app;
      TextView tvNombreApp = ViewBindings.findChildViewById(rootView, id);
      if (tvNombreApp == null) {
        break missingId;
      }

      id = R.id.tv_subtitulo;
      TextView tvSubtitulo = ViewBindings.findChildViewById(rootView, id);
      if (tvSubtitulo == null) {
        break missingId;
      }

      return new FragmentSplashBinding((ConstraintLayout) rootView, ivLogo, progressBar,
          tvNombreApp, tvSubtitulo);
    }
